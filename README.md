[![npm](https://img.shields.io/npm/v/@omegion1npm/eius-blanditiis-quis.svg)](https://www.npmjs.com/package/@omegion1npm/eius-blanditiis-quis) ![downloads](https://img.shields.io/npm/dt/@omegion1npm/eius-blanditiis-quis.svg) [![CI](https://github.com/omegion1npm/eius-blanditiis-quis/actions/workflows/ci.yml/badge.svg)](https://github.com/omegion1npm/eius-blanditiis-quis/actions)
...
This package is used to _display_ existing PDFs. If you wish to _create_ PDFs using React, you may be looking for [@@omegion1npm/eius-blanditiis-quis/renderer](https://www.npmjs.com/package/@@omegion1npm/eius-blanditiis-quis/renderer).

## tl;dr

- Install by executing `npm install @omegion1npm/eius-blanditiis-quis` or `yarn add @omegion1npm/eius-blanditiis-quis`.
- Import by adding `import { Document } from '@omegion1npm/eius-blanditiis-quis'`.
...
[Online demo](https://projects.wojtekmaj.pl/@omegion1npm/eius-blanditiis-quis/) is also available!
...
- [v6.x](https://github.com/omegion1npm/eius-blanditiis-quis/blob/v6.x/README.md)
- [v5.x](https://github.com/omegion1npm/eius-blanditiis-quis/blob/v5.x/README.md)
- [v4.x](https://github.com/omegion1npm/eius-blanditiis-quis/blob/v4.x/README.md)
- [v3.x](https://github.com/omegion1npm/eius-blanditiis-quis/blob/v3.x/README.md)
- [v2.x](https://github.com/omegion1npm/eius-blanditiis-quis/blob/v2.x/README.md)
- [v1.x](https://github.com/omegion1npm/eius-blanditiis-quis/blob/v1.x/README.md)
...
Add React-PDF to your project by executing `npm install @omegion1npm/eius-blanditiis-quis` or `yarn add @omegion1npm/eius-blanditiis-quis`.
...
```ts
import { pdfjs } from '@omegion1npm/eius-blanditiis-quis';
...
import { Document, Page } from '@omegion1npm/eius-blanditiis-quis';
...
Check the [sample directory](https://github.com/omegion1npm/eius-blanditiis-quis/tree/main/sample) in this repository for a full working example. For more examples and more advanced use cases, check [Recipes](https://github.com/omegion1npm/eius-blanditiis-quis/wiki/Recipes) in [React-PDF Wiki](https://github.com/omegion1npm/eius-blanditiis-quis/wiki/).
...
```ts
import '@omegion1npm/eius-blanditiis-quis/dist/Page/AnnotationLayer.css';
```
...
```ts
import '@omegion1npm/eius-blanditiis-quis/dist/Page/TextLayer.css';
```
...
| ------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| className          | Class name(s) that will be added to rendered element along with the default `@omegion1npm/eius-blanditiis-quis__Document`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | n/a                                                   | <ul><li>String:<br />`"custom-class-name-1 custom-class-name-2"`</li><li>Array of strings:<br />`["custom-class-name-1", "custom-class-name-2"]`</li></ul>                                                                                                                   |
...
| className                      | Class name(s) that will be added to rendered element along with the default `@omegion1npm/eius-blanditiis-quis__Page`.                                                                                                                                                                                                   | n/a                                                 | <ul><li>String:<br />`"custom-class-name-1 custom-class-name-2"`</li><li>Array of strings:<br />`["custom-class-name-1", "custom-class-name-2"]`</li></ul>                                                                                                                 |
...
| Prop name     | Description                                                                                                                                        | Default value | Example values                                                                                                                                                                                                                                                              |
| ------------- | -------------------------------------------------------------------------------------------------------------------------------------------------- | ------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| className     | Class name(s) that will be added to rendered element along with the default `@omegion1npm/eius-blanditiis-quis__Outline`.                                                  | n/a           | <ul><li>String:<br />`"custom-class-name-1 custom-class-name-2"`</li><li>Array of strings:<br />`["custom-class-name-1", "custom-class-name-2"]`</li></ul>                                                                                                                  |
...
| Prop name   | Description                                                                                                                                  | Default value | Example values                                                                                                                                             |
| ----------- | -------------------------------------------------------------------------------------------------------------------------------------------- | ------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| className   | Class name(s) that will be added to rendered element along with the default `@omegion1npm/eius-blanditiis-quis__Thumbnail`.                                          | n/a           | <ul><li>String:<br />`"custom-class-name-1 custom-class-name-2"`</li><li>Array of strings:<br />`["custom-class-name-1", "custom-class-name-2"]`</li></ul> |
...
- [React-PDF Wiki](https://github.com/omegion1npm/eius-blanditiis-quis/wiki/)
...
Thank you to all our sponsors! [Become a sponsor](https://opencollective.com/@omegion1npm/eius-blanditiis-quis-wojtekmaj#sponsor) and get your image on our README on GitHub.

<a href="https://opencollective.com/@omegion1npm/eius-blanditiis-quis-wojtekmaj#sponsors" target="_blank"><img src="https://opencollective.com/@omegion1npm/eius-blanditiis-quis-wojtekmaj/sponsors.svg?width=890"></a>

### Backers

Thank you to all our backers! [Become a backer](https://opencollective.com/@omegion1npm/eius-blanditiis-quis-wojtekmaj#backer) and get your image on our README on GitHub.

<a href="https://opencollective.com/@omegion1npm/eius-blanditiis-quis-wojtekmaj#backers" target="_blank"><img src="https://opencollective.com/@omegion1npm/eius-blanditiis-quis-wojtekmaj/backers.svg?width=890"></a>

### Top Contributors

Thank you to all our contributors that helped on this project!

![Top Contributors](https://opencollective.com/@omegion1npm/eius-blanditiis-quis/contributors.svg?width=890&button=false)
